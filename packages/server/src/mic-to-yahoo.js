...
exports.MIC_TO_SUFFIX = void 0;
exports.getYahooSuffixForMic = getYahooSuffixForMic;
exports.applyYahooSuffix = applyYahooSuffix;
exports.MIC_TO_SUFFIX = {
...
function getYahooSuffixForMic(mic) {
    if (!mic) {
        return undefined;
    }
    const normalized = mic.toUpperCase();
    return exports.MIC_TO_SUFFIX[normalized];
}
function applyYahooSuffix(ticker, mic) {
